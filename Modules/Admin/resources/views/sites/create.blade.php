    ...
    <div class="row">
        ...
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-body">
                {!! Form::open(array('route' => 'sites.store','method'=>'POST','enctype'=>'multipart/form-data','class'=>'row g-6','id'=>'formCreateSite')) !!}
                ...
                <div class="col-md-6">
                  ...
                  {!! Form::text('site_code', null, array('class' => 'form-control','id'=>'site_code')) !!}
                </div>
