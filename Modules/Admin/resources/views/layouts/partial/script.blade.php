...
<script type="text/javascript">
    ...
    var tblcol = [
         //   { 'name': 'created_at.timestamp', 'data': { '_': 'created_at.display', 'sort': 'created_at' }, sClass: 'text-center nk-tb-col' },
          { data: 'created_at', name: 'users.created_at', sClass: 'nk-tb-col' },
            { data: 'name', name: 'users.name', sClass: 'nk-tb-col' },
            { data: 'email', name: 'users.email', searchable: true, visible: false},
            { data: 'mobile_no', name: 'users.mobile_no', sClass: 'nk-tb-col' }, 
            { data: 'status', name: 'users.status', orderable: false,  serachable: false, sClass: 'text-center nk-tb-col' },
...
var tblcol2 = [
         //   { 'name': 'created_at.timestamp', 'data': { '_': 'created_at.display', 'sort': 'created_at' }, sClass: 'text-center nk-tb-col' },
          { data: 'created_at', name: 'created_at', sClass: 'nk-tb-col' },
            { data: 'site_name', name: 'site_name', sClass: 'nk-tb-col' },
            { data: 'site_code', name: 'site_code', visible: true}, 
            { data: 'status', name: 'status', orderable: false,  serachable: false, sClass: 'text-center nk-tb-col' },
            { data: 'action', name: 'action', orderable: false, serachable: false, sClass: 'text-center nk-tb-col nk-tb-col-tools' },
        ];
