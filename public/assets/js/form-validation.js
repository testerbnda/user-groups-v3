! function() {
...
}(), document.addEventListener("DOMContentLoaded", function(e) {
    {
        ...
        s && s.flatpickr({
            ...
            name: "tech",
            source: (l = ["ReactJS", "Angular", "VueJS", "Html", "Css", "Sass", "Pug", "Gulp", "Php", "Laravel", "Python", "Bootstrap", "Material Design", "NodeJS"], function(e, a) {
                var t = [],
                    o = new RegExp(e, "i");
                $.each(l, function(e, a) {
                    o.test(a) && t.push(a)
        ...
        }), new Tagify(o), o.addEventListener("change", function() {
