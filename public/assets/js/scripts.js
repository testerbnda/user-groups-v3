"use strict";
! function(r, u) {
    r.Package.name = "DashLite", r.Package.version = "1.2.0";
    var c = u(window),
        l = u("body"),
        d = u(document),
        t = "nk-menu",
    ...
    r.ClassBody = function() {
        ...
        r.BreakClass("." + f, p.lg, {
            ...
            r.BreakClass("." + f, p.lg), r.BreakClass("." + o, p.lg), r.BreakClass("." + i, p.lg), r.BreakClass("." + g, p.lg, {
                classAdd: e
            }), r.BreakClass("." + n, p.xl, {
                classAdd: e
            })
        ...
        r.BS.menutip("a.nk-menu-link"), r.BS.tooltip(".nk-tooltip"), r.BS.tooltip(".btn-tooltip", {
            placement: "top"
        }), r.BS.tooltip('[data-toggle="tooltip"]'), r.BS.tooltip(".tipinfo", {
            placement: "right"
        ...
        r.TGL.content(".toggle"), r.TGL.expand(".toggle-expand"), r.TGL.showmenu(".nk-nav-toggle"), r.TGL.ddmenu("." + t + "-toggle", {
            self: t + "-toggle",
            child: t + "-sub"
        })
